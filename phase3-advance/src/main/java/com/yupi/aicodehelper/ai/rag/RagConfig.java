 ...
 * 加载 RAG
 */
// @Configuration (暂时关闭，因为本地模型不支持 embeddings)
public class RagConfig {
    ...
    @Bean
    public ContentRetriever contentRetriever(EmbeddingModel ollamaEmbeddingModel, EmbeddingStore<TextSegment> embeddingStore) {
        // ------ RAG ------
        // 1. 加载文档
